...
my %iomap=('A'=>'I','B'=>'I','C'=>'I', 'CI'=>'I', 'CO'=>'O', 'CN'=>'I','CLK'=>'I','D'=>'I','EN'=>'I','Q'=>'O','R'=>'I','S'=>'I','Y'=>'O','YC'=>'O','YS'=>'O','gnd'=>'','vdd'=>'','GND'=>'','VDD'=>'','Z'=>'O','DI'=>'I','DO'=>'O','OEN'=>'I','YPAD'=>'O','gnd2'=>'','vdd2'=>'','GND2'=>'','VDD2'=>'','vss'=>'','VSS'=>'', 'VNW'=>'', 'VPW'=>'');
...
if($ARGV[0] && open IN,"<$ARGV[0]")
{
  while(<IN>)
  {
    ...
    elsif(m/^X?_?[MNPi]?[_\d]+ (\w+#?) (\w+#?) (\w+#?) (\w+#?) (pfet|nfet|nmos|pmos|hnfet|hpfet|enbsim3|epbsim3|sky130_fd_pr__nfet_01v8|sky130_fd_pr__pfet_01v8)/i)
    {
      my ($g,$d,$s,$m)=($2,$1,$3,$5);
      if($d=~m/^(vdd|gnd)$/i)
      {
