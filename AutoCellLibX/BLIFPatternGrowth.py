...
def growASeqOfClusters(BLIFGraph, clusterSeq, clusterNum, patternNum, paintPattern=False, featureLen=20):
        ...
        for cell in cluster.cellsContained:
            ...
            for inputNet in cell.inputNets:
                ...
                if not curNeighbor in thisClusterNeighbors:
                    thisClusterNeighbors[curNeighbor] = curNeighbor.stdCellType.typeName + "_" + "c" + str(cellOrderId) + "i" + str(inOrderId)
                else:
                    thisClusterNeighbors[curNeighbor] += "c" + str(cellOrderId) + "i" + str(inOrderId)
            ...
            for outputNet in cell.outputNets:
                for curNeighbor in outputNet.succCells:
                    ...
                    if not curNeighbor in thisClusterNeighbors:
                        thisClusterNeighbors[curNeighbor] = curNeighbor.stdCellType.typeName + "_" + "c" + str(cellOrderId) + "o" + str(outOrderId)
                    else:
                        thisClusterNeighbors[curNeighbor] += "c" + str(cellOrderId) + "o" + str(outOrderId)
    ...
    sortedNeighborCode = sorted(sortedNeighborFeatures, key=lambda tup: -tup[1])
    ...
    for neighborCode, codeCnt in sortedNeighborCode:
        print(feature2Neighbors[neighborCode][0].stdCellType.typeName, " code: (", neighborCode, ") cnt:", codeCnt)
    ...
    for neighborCode, codeCnt in sortedNeighborCode[:1]:
        ...
        print("extended ", len(newClusters), " clusters and new pattern is : ", newClusters[0].patternExtensionTrace, " and the size of each clustet is ", len(newClusters[0].cellsContained))
